...
class _TrendingState extends State<Trending>
  ...
  Widget build(BuildContext context) {
    super.build(context);
    return FutureBuilder<TrendingModel>(
      future:
          Provider.of<APIRequests>(context, listen: false).getTrendingData(),
        ...
        return SmartRefresher(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              final data = snapshot.data.symbols[index];
              return Padding(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                ...
                launch("https://finance.yahoo.com/quote/${data.symbol}");
              },
              child: Padding(
                padding: const EdgeInsets.only(
                  top: 6.0,
                ...
                child: ExtendedImage.network(
                  "https://upload.wikimedia.org/wikipedia/commons/e/e4/YahooFinanceLogo.png",
                  height: 10,
                  color: Colors.white,
                ),
              ),
...
class BackBodyWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return FutureBuilder<StocksInfo>(
      future: Provider.of<APIRequests>(context, listen: false)
          .getStocksInfo(symbol),
      builder: (context, snapshot) {
        if (!snapshot.hasData) {
          return const Center(
            child: CircularProgressIndicator(),
        ...
        return Padding(
          ...
          child: Row(
            ...
            children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          data.type == null ? "-" : data.type.toUpperCase(),
                          style: GoogleFonts.dmSans(
                            color: const Color(0xff3979d7),
                            fontWeight: FontWeight.bold,
                          ),
              ...
              Row(
                children: [
                  if (data.percentChange.toString().contains("-"))
                    const Icon(
                  ...
                  Text(
                    ...
                    style: GoogleFonts.dmSans(
                      color: data.percentChange.toString().contains("-")
                          ? Colors.red
                          : Colors.green,
                      fontWeight: FontWeight.bold,
                      fontSize: 18,
